...
const Testimonial = ({
  ...
  return (
    <div className="flex w-[21.8em] flex-col items-center gap-6 text-center lg:gap-[3.5em]">
      ...
      <span className="font-barlow font-[600] leading-[1.7em] tracking-[-0.3px] text-veryDarkGrayishBlue md:px-0 lg:text-[1.15rem]">
        {text}
      </span>
          ...
          <div className="flex h-[23em] justify-center bg-[#90D4C5]">
            <div className="mt-[4.6em] flex w-[20em] flex-col items-center justify-start md:w-[18em]">
              ...
              <div className="mt-[5.5em] flex gap-[1.8em]">
                ...
                >
                  <svg className="scale-125 md:scale-100" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                >
                  <svg className="scale-125 md:scale-100" width="20" height="17" xmlns="http://www.w3.org/2000/svg">
                    <path
