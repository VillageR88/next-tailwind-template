    ...
    >
      <svg
        className={`h-[1em] w-fit rounded-full outline outline-1 outline-offset-[6px] duration-300  ${
          hover ? 'outline-[#707ABF]' : 'outline-white'
        }`}
        fill={hover ? '#7DA2FB' : 'white'}
        height="800px"
        width="800px"
        version="1.1"
        id="Layer_1"
    ...
    >
      ...
      >
        <path
          ...
          fill={hover ? '#7DA2FB' : 'hsl(193, 100%, 96%)'}
        />
        <path
          className="duration-300"
      ...
      <main className="h-full w-full bg-white ">
        <div className="mt-[5em] flex flex-col-reverse items-center bg-[url('./images/bg-curve-mobile.svg')] bg-bottom bg-no-repeat px-6 pb-[10em] md:flex-row md:bg-[url('./images/bg-curve-desktop.svg')] md:px-0 md:pb-[17.8em] xl:px-[5em]">
          <form className=" flex h-fit w-full flex-col items-center justify-center gap-[1.5em] rounded-[0.5em] text-left md:px-6 lg:px-10 xl:px-0">
            ...
            <div className="flex w-full flex-col gap-[1.5em] xl:flex-row xl:gap-[1em]">
              <input
                inputMode="email"
                type="text"
            ...
            <div className="mt-[6em] flex flex-col md:mt-0 md:flex-row md:gap-[3em] lg:gap-[4em] xl:gap-[12em]">
              <div className="mt-[-0.55em] flex flex-col items-start gap-[0.85em] text-[#BFC6CE] duration-300">
                {['About Us', 'Jobs', 'Press', 'Blog'].map((x, i) => (
                  <button key={i} className="font-openSans duration-300 hover:text-[#707ABF]">
                    {x}
                  </button>
                ))}
              </div>
