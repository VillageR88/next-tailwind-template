...
const MainRow1 = () => {
  return (
    <div className="flex w-full flex-col-reverse bg-[#FFFFFF] px-2 pb-[5em] md:h-[34.2em] md:flex-row md:gap-0 md:px-0 md:pb-0 lg:gap-[2em]">
      <div className="mb-[0.4em] flex flex-col items-center justify-center px-6 text-center md:w-[53%] md:items-start md:pl-[2em] md:text-left lg:pl-[5em] xl:pr-[1em] min-[1458px]:pl-[10.3em]">
      ...
      <div className="flex items-center justify-start md:w-[47%]">
        <Image
          className=" mb-[0.3em] h-fit w-fit min-w-[30em] md:ml-[2em] lg:min-w-[111%] xl:ml-[3.2em]"
          height={100}
          width={100}
