          ...
          {name === DropdownName.features ? (
            ...
            <div className="absolute">
              ...
              <div className=" ml-[-5.1em] flex flex-col gap-[0.8em] rounded-[1em] bg-white pb-4 pl-6 pr-6 pt-6 text-[0.9rem] font-[500] text-mediumGray drop-shadow-2xl ">
                <span className="flex gap-4 hover:text-almostBlack hover:underline">History</span>
                <span className="flex gap-4 hover:text-almostBlack hover:underline">Out Team</span>
                <span className="flex gap-4 hover:text-almostBlack hover:underline">Blog</span>
              </div>
            </div>
          )}
        </div>
