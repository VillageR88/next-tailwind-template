...
const MainPart1 = () => (
  <div className="flex min-h-[737px] w-full max-w-[1276px] items-start justify-between self-start">
    <div className="flex size-full min-h-[737px] w-[978px] flex-col rounded-b-[35px] bg-gradient-to-br from-transparent via-[rgba(214,252,254,0.3)] to-[#D6E6FE] pl-[116px]">
