...
const MainPart2 = () => (
  <div className="mt-[64px] flex h-full w-full flex-col items-center px-[24px] md:mt-[67px] xl:mt-[64px]">
    ...
    <div className="mt-[64px] flex min-h-[240px] w-full max-w-[590px] flex-col items-center md:mt-[80px] xl:max-w-[540px]">
      <span className="text-center text-[16px] font-[900] leading-[26px] tracking-[4px] text-[#4D96A9]">
