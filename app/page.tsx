...
export default function Home() {
  return (
    <div className="min-h-screen">
      <nav className="col-span-2 flex h-[50em] flex-col items-start items-center gap-[6em] bg-header bg-cover bg-top">
        ...
        <div className="flex flex-col items-center gap-[1.3em] font-fraunces text-[2rem] font-[900] tracking-[0.18em] text-white md:text-[3.5rem]">
