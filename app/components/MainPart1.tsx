...
const MainPart1 = () => (
  <div className="flex min-h-[821px] w-full max-w-full flex-col items-start justify-between min-[1200px]:min-h-[737px] min-[1200px]:max-w-[1276px] min-[1200px]:flex-row min-[1200px]:self-start">
    <div className="flex size-full min-h-[640px] w-full flex-col items-center rounded-b-[35px] bg-gradient-to-br from-transparent via-[rgba(214,252,254,0.3)] to-[#D6E6FE] min-[1200px]:min-h-[737px] min-[1200px]:w-[978px] min-[1200px]:items-start min-[1200px]:pl-[90px] min-[1300px]:pl-[100px] min-[1400px]:pl-[116px]">
      ...
      <section className="mt-[40px] flex min-h-[202px] max-w-[686px] flex-col items-center justify-between text-center min-[1200px]:mt-[127px] min-[1200px]:min-h-[271px] min-[1200px]:max-w-[564px] min-[1200px]:items-stretch min-[1200px]:text-start">
