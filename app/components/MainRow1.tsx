...
const MainRow1 = () => {
  return (
    <div className="p flex w-full flex-col-reverse gap-[2em] bg-[#FFFFFF] px-2 pb-[5em] md:h-[39.3em] md:flex-row md:gap-0 md:px-0 md:pb-0">
      <div className="mb-[0.4em] flex flex-col items-center justify-center px-6 text-center md:w-[49.7%] md:items-start md:pl-[2em] md:text-left lg:pl-[5em] xl:pr-[1em] min-[1458px]:pl-[10.3em]">
        ...
        <p className="mb-[2.4em] mt-[2.2em] max-w-[20em] px-1 tracking-[-0.03em] text-[hsl(233,8%,62%)] md:px-0 xl:text-[1.05rem]">
      ...
      <div className="z-10 flex items-center justify-start md:w-[50.3%]">
        <Image
          className="h-fit w-full md:w-fit md:min-w-[26em]"
          height={100}
          width={100}
