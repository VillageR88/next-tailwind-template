const MainPart1 = () => (
  <div className="flex size-full h-[800px] w-full max-w-[1275px]">
    ...
    <h2 className="HeadingXL absolute z-10 ml-[165px] mt-[189px] whitespace-pre bg-gradient-to-r from-white from-[63.6%] to-black to-[63.6%] bg-clip-text text-[2rem] text-transparent">
      {'MODERN\nART GALLERY'}
    </h2>
