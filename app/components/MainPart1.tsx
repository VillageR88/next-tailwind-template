...
const MainPart1 = () => (
  <div className="mt-[67px] flex size-full h-full max-w-[343px] flex-col items-center px-2 transition-all duration-500 sm:px-0 md:h-[990px] md:max-h-[482px] md:max-w-[689px] xl:h-[600px] xl:max-w-[1110px] xl:flex-row xl:items-stretch">
    <div className="flex size-full flex-col justify-between md:flex-row">
      ...
      <div className="mt-[38px] size-full h-[240px] w-[343px] self-center bg-[url('../public/assets/images/image-hero-landscape@2x.webp')] bg-cover md:ml-[-165px] md:mt-0 md:h-[482px] md:w-[281px] md:bg-[url('../public/assets/images/image-hero-portrait@2x.webp')] xl:ml-[-161px] xl:mt-[88px] xl:h-[600px] xl:w-[350px]"></div>
    </div>
