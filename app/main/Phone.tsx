...
const Phone = ({
  ...
  return (
    <div className="flex h-[631px] w-[307px] flex-col items-center justify-center bg-[url('../public/assets/images/illustration-phone-mockup.svg')] bg-center bg-no-repeat pt-[10px]">
