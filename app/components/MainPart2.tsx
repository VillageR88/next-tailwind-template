...
const MainPart2 = () => (
  <div className="flex size-full justify-center pl-8 lg:px-8 xl:pl-0">
    <div className="flex min-h-[480px] w-full justify-center sm2:mt-[83px] sm2:block lg:max-w-[1110px] ">
      <div className="flex flex-col sm2:flex-row sm2:gap-[69px] lg:max-w-[1395px] lg:gap-[125px] ">
        <div className="mt-[64px] flex min-h-[312px] w-full flex-col items-center gap-[40px] sm2:mt-[60px] sm2:items-start lg:max-w-[445px]">
        ...
        <div className="flex min-h-[480px]  w-full justify-between lg:mr-[-285px] lg:max-w-[825px]">
          <div className="size-full rounded-[20px] bg-[url('../public/assets/images/mobile/image-keyboard.jpg')] bg-cover sm2:min-w-[478px] sm2:max-w-[540px] sm2:bg-[url('../public/assets/images/desktop/image-keyboard.jpg')]"></div>
