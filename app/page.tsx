...
import ButtonWithSlider from './components/ButtonWithSlider';
...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-start font-roboto">
      <Header />
      <main className="flex h-[50.5em] w-full flex-col bg-[url('./images/home-slide_img.jpg')] bg-[50%_0%] px-5 sm:px-10">
