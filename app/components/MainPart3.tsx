  ...
  <div className=" mt-[30px] min-h-[480px] w-full max-w-[1110px] px-8 min-[1150px]:px-0">
    <div className="flex h-[500px] flex-col justify-between gap-6 lg:flex-row min-[1150px]:ml-[-285px] min-[1150px]:max-w-[1395px]">
      <div className="flex min-h-[320px] w-full justify-between gap-[30px] min-[850px]:min-h-[400px] lg:min-h-[480px] lg:max-w-[730px] min-[1150px]:max-w-[1015px]">
        ...
        <div className="size-full max-w-[214px] overflow-hidden rounded-[20px] bg-[#F16718] md:max-w-[350px] lg:max-w-[255px]">
        ...
        <div className="size-full max-w-[445px] rounded-[20px] bg-[url('../public/assets/images/desktop/image-glass-and-keyboard.jpg')] bg-cover bg-[0_-50px] md:min-w-[420px] lg:bg-center"></div>
      </div>
