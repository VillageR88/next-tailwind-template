const MainPart2 = () => (
  <div className="mt-[120px] flex h-[1131px] w-full max-w-[1110px] flex-col gap-[30px] self-center px-8 xl:px-0">
    <div className="flex min-h-[400px] w-full justify-between gap-6 xl:gap-0">
      ...
      <div className="h-[400px] w-[635px]  bg-[url('../public/assets/images/tablet/image-grid-1@2x.jpg')] bg-cover bg-center min-[700px]:bg-[url('../public/assets/images/desktop/image-grid-1@2x.jpg')]"></div>
    </div>
