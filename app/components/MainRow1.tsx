...
const MainRow1 = () => {
  return (
    <div className="flex h-[41em] w-full bg-[#FAFAFA]">
      <div className="flex w-fit flex-col justify-center md:pl-[2em] lg:pl-[5em] xl:pr-[1em] min-[1458px]:pl-[10.3em]">
        <h1 className="font-[300] leading-[1.2em] text-[hsl(233,26%,24%)] md:text-[2.5rem] lg:text-[2.8rem] xl:text-[3.42rem]">
