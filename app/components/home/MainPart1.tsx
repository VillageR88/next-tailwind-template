...
const MainPart1 = () => (
  <div className="flex size-full min-h-[630px] max-w-[1040px] flex-col items-center justify-between self-center md:min-h-[700px] md:flex-row md:items-stretch md:pr-8 min-[900px]:pl-8 min-[940px]:pr-16 min-[1000px]:pr-24 xl:h-[800px] xl:max-w-[1375px] xl:justify-start xl:pl-0 xl:pr-8">
    ...
    <div className="min-h-[240px] w-full max-w-[437px] bg-[url('../public/assets/images/mobile/image-hero@2x.jpg')] bg-cover bg-center md:w-[437px] md:max-w-full md:bg-[url('../public/assets/images/tablet/image-hero@2x.jpg')] xl:w-[540px] xl:bg-[url('../public/assets/images/desktop/image-hero@2x.jpg')]"></div>
    <div className="BodyM mt-[32px] flex h-fit min-h-[358px] w-full max-w-[339px] flex-col justify-between gap-[32px] px-2 md:ml-[-65px] md:mt-[145px] md:px-0 lg:min-h-[410px] lg:gap-[48px] xl:mt-[190px] xl:h-[296px] xl:w-[350px]">
