...
const MainPart1 = () => (
  <div className="flex size-full max-w-[1040px] flex-col items-center justify-between self-center  md:min-h-[700px] md:flex-row md:items-stretch md:pr-8 min-[900px]:pl-8 min-[940px]:pr-16 min-[1000px]:pr-24 xl:h-[800px] xl:max-w-[1375px] xl:justify-start xl:pl-0 xl:pr-8">
    ...
    <div className="hidden size-full bg-almostBlack md:max-w-[450px] xl:block"></div>
