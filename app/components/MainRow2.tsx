const MainRow2 = () => {
  ...
  return (
    <div className="flex w-full flex-col gap-[2em] bg-[#FFFFFF] pb-[5em] pt-[3em] md:h-[39.3em] md:flex-row md:gap-0 md:pb-0 md:pr-6">
      ...
      <ul className="z-10 ml-[1em] flex flex-col items-center justify-start gap-[2.3em] md:ml-[1.7em] md:w-[50%] md:items-start">
        {articles.map((article, index) => (
          <li className="flex flex-col gap-[1.6em] md:flex-row md:items-start" key={index}>
            <div className="flex items-center gap-[0.8em] rounded-l-[1.8em] bg-[#FFF0EB] md:bg-transparent">
              ...
              <h3 className="flex pr-2 text-[0.97rem] font-[700] tracking-[-0.03em] text-[hsl(233,26%,24%)] md:hidden md:pr-0">
                {article.title}
              </h3>
            </div>
            <div className="mt-[0.5em] flex flex-col gap-[1.2em]">
              <h3 className="hidden text-[0.97rem] font-[700] tracking-[-0.03em] text-[hsl(233,26%,24%)] md:flex">
                {article.title}
              </h3>
              <span className="px-2 text-[0.88rem] leading-[1.7em] text-[hsl(233,8%,62%)] md:max-w-[28em] md:px-0 md:text-[0.97rem]">
                {article.description}
              </span>
            </div>
          </li>
