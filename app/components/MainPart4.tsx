...
const MainPart4 = () => (
  <div className="flex w-full justify-center px-10">
    <div className="mt-[111px] flex min-h-[323px] w-full max-w-[1110px] grid-cols-2 flex-col items-center justify-between gap-[64px] sm2:mt-[168px] sm2:grid sm2:gap-[30px] sm2:gap-y-[72px] lg:grid-cols-4">
      {items.map((item, index) => (
        <div
          key={index}
          className="flex size-full max-w-[460px] flex-col items-center gap-[24px] sm2:max-w-[281px] sm2:items-start sm2:gap-[48px]"
        >
          ...
          <section className="flex flex-col items-center gap-[24px] text-center sm2:items-start sm2:text-start">
