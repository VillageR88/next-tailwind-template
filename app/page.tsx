    ...
    return (
      ...
      >
        <svg className="ml-[-0.2em]" width="12" height="18" xmlns="http://www.w3.org/2000/svg">
          <path d="M11 1 3 9l8 8" stroke={color} strokeWidth="3" fill="none" fill-rule="evenodd" />
        </svg>
      </button>
    );
  };
    ...
    return (
      ...
      >
        <svg width="13" height="18" xmlns="http://www.w3.org/2000/svg">
          <path d="m2 1 8 8-8 8" stroke={color} stroke-width="3" fill="none" fill-rule="evenodd" />
        </svg>
      </button>
    );
  };
  ...
  return (
    <div className={`flex min-h-screen flex-col items-center justify-start bg-white`}>
      ...
      <div className=" flex min-h-full w-full flex-col font-kumbhSans  xl:px-[3em] xxl:px-[10.3em]">
        <nav className="flex flex-col py-4 md:px-[2em] md:py-0 md:pt-[1.5em] xxl:px-0">
          <div className="flex items-center justify-between">
            <div className="flex gap-[3.5em] text-darkGrayishBlue">
              <Image className="h-full" src={logo as string} alt="logo" />
              <div className="hidden gap-[1.98em] text-[0.95rem] md:flex">
            ...
            <div className="flex items-center gap-[2.9em]">
              <div>
                <Cart />
                {storage !== 0 && (
                  <span className="absolute ml-[-1.5em] mt-[-0.7em] rounded-[2em] bg-orange px-[0.8em] text-[0.55rem] text-white">
                    {storage}
                  </span>
                )}
                {cartShown && (
                  <div
                    ...
                    className="absolute z-10 ml-[-15em] mt-[1.5em] flex h-[17em] w-[22em] flex-col rounded-[0.5em] bg-white shadow-2xl xl:ml-[-10em]"
                  >
        ...
        <main className="flex h-full w-full flex-col items-center justify-center pb-[2.5em] pr-0 md:mt-[5.5em] md:flex-row md:gap-0 md:px-0 md:pr-6 lg:gap-[4em] lg:px-[3em] xl:gap-[6em] xxl:gap-[8em]">
          ...
          <div className="flex w-full flex-col items-start md:w-[33em]">
            <span className="mb-[1em] text-[0.85rem] font-[700] tracking-[0.1em] text-[orange]">SNEAKER COMPANY</span>
            <span className="mb-[0.8em] text-[2.8rem]  font-[700]  leading-[1em] text-[#1E1F25]">
            ...
            <div className="flex h-full w-full  flex-col gap-[1em] md:h-[3.5em] md:flex-row">
