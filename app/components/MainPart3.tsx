const MainPart3 = () => (
  <div className=" mt-[30px] min-h-[480px] w-full px-8 min-[1150px]:max-w-[1110px] min-[1150px]:px-0">
    <div className="flex h-full min-h-[500px] flex-col justify-between gap-6 lg:flex-row min-[1150px]:ml-[-285px] min-[1150px]:max-w-[1395px]">
      <div className="flex h-[320px] min-h-[320px] w-full justify-between gap-[30px] min-[850px]:min-h-[400px] lg:h-[480px] lg:min-h-[480px] lg:max-w-[730px] min-[1150px]:max-w-[1015px]">
        <div className="hidden size-full max-h-[240px] rounded-[20px] bg-[#E8EFF2] lg:max-w-[255px] min-[1150px]:block"></div>
        <div className="size-full max-w-[214px]  overflow-hidden rounded-[20px] bg-[#F16718] md:max-w-[330px] lg:max-w-[255px]">
        ...
        <div className="sm2:bg-[0_-30px] size-full rounded-[20px] bg-[url('../public/assets/images/desktop/image-glass-and-keyboard.jpg')] bg-cover md:min-w-[420px] md:bg-[0_-50px] lg:max-w-[480px] lg:bg-center"></div>
      </div>
      <div className="sm2:flex-row sm2:gap-[70px] sm2:text-start mt-[75px] flex w-full flex-col items-center justify-between gap-[24px] text-center lg:mt-[112px] lg:min-h-[108px] lg:min-h-[312px] lg:max-w-[255px] lg:flex-col lg:justify-stretch  lg:gap-[50px]">
